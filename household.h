/**
 * Student Name: Jialin Wu
 * Student ID: 991675146
 * Date modified: Nov 15th 2023
...
void displayRecordsOfOneRegion(NodePtr top, char region[]); //to do 2
...
void initializeData(NodePtr* top); //to-do 01
...
char* townMappingRegionBased(int region, int x);  //do to 10
